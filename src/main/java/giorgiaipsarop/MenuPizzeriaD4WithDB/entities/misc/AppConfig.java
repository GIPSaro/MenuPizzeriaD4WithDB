...
import giorgiaipsarop.MenuPizzeriaD4WithDB.entities.classes.Table;
...
public class AppConfig {
    ...
    public Pizza pizzaMargheritaBean() {
        ...
        return new Pizza("Pizza Margherita", toppingsList, false, 4.5);
    }
    ...
    public Pizza pizzaHawaiianBean() {
        ...
        return new Pizza("Hawaiian Pizza", toppingsList, false, 8);
    }
    ...
    public Pizza pizzaSalamiBean() {
        ...
        return new Pizza("Salami Pizza", toppingsList, false, 7.5);
    }
    ...
    public Pizza pizzaSalamiXlBean() {
        ...
        toppingsList.add(toppingCheeseBean());
        toppingsList.add(toppingSalamiBean());
        return new Pizza("Salami Pizza XL", toppingsList, true, 12);
    }
